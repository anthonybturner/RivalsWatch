"""
Django settings for marvel_rivals project.
...
SECRET_KEY = config('SECRET_KEY', default=config('DEFAULT_SECRET_KEY'))

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost').split(',')
# Add your Render URL manually
RENDER_HOSTNAME = config('RENDER_HOST')
...
CORS_ALLOWED_ORIGINS = [
    "https://rivalswatch.onrender.com",  # Your front-end URL
    "http://localhost:3000",  # For local development
]

CORS_ALLOW_CREDENTIALS = True  # If using authentication with APIs